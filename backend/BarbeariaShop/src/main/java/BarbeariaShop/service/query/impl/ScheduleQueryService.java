...
import BarbeariaShop.exception.ScheduleInUseException;
import BarbeariaShop.repository.IScheduleRepository;
...
public class ScheduleQueryService implements IScheduleQueryService {
    ...
    public ScheduleEntity findById(final long id) {
        return repository.findById(id).orElseThrow(
                () -> new ResourceNotFoundException("Agendamento com ID " + id + " não foi encontrado"));
    }
